...
class _TestPatientInfoScreenState extends State<TestPatientInfoScreen> {
  ...
  void _clearData() {
    setState(() {
      ...
      _extNumController.clear();
      _intNumController.clear();
    });
  }
  ...
  bool _isFormValid() {
    return _nameController.text.isNotEmpty &&
        ...
        _extNumController.text.isNotEmpty;
  }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('¿Para quién es esta prueba?',
                              style:
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    if (_isFormValid()) {
                      context.push(AppRoutes.testConfirmation);
                    }
                  },
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(
                child: Column(
                  ...
                  Text(
                      'Esta prueba no se puede realizar para la edad del paciente. Puedes revisar los datos ingresados o elegir otra.',
                      style: AppTheme.body()
  ...
  Widget _buildAddressForm() {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      _buildDropdown('Estado *', _addressState, _states,
          (val) => setState(() => _addressState = val),
          errorText: getDropdownError(_addressState)),
      _buildDropdown('Municipio *', _municipality, _municipalities,
          (val) => setState(() => _municipality = val),
          errorText: getDropdownError(_municipality)),
      _buildDropdown('Colonia *', _colonia, _colonias,
          (val) => setState(() => _colonia = val),
  ...
  Widget _buildTextField(String label, TextEditingController controller,
      {bool readOnly = false, IconData? prefixIcon, String? errorText}) {
  ...
  Widget _buildDropdown(String label, String? value, List<String> items,
      ...
      {bool readOnly = false, String? errorText}) {
    final bool hasError = errorText != null;
    return Padding(
      padding: const EdgeInsets.only(bottom: 20),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
  ...
  Widget _buildDivider(bool isActive) => Expanded(
      flex: 1,
      child: Container(
          height: 1.5,
