...
class VaccineConfirmationScreen extends StatefulWidget {
  const VaccineConfirmationScreen({super.key});

  @override
  State<VaccineConfirmationScreen> createState() => _VaccineConfirmationScreenState();
}

class _VaccineConfirmationScreenState extends State<VaccineConfirmationScreen> {
  ...
  void _confirmAppointment() async {
    ...
    context.go(AppRoutes.vaccineSuccess);
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _CollapsibleSection(
                            ...
                            child: _buildVaccineTypeSummary(),
                          ),
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    style: AppTheme.body().copyWith(
                                        ...
                                        height: 1.4),
                                    children: const [
                                      TextSpan(text: 'Autorizo la aplicación de la vacuna seleccionada, otorgo mi '),
                                      TextSpan(
                                      ...
                                      TextSpan(text: ' y declaro haber leído el '),
                                      TextSpan(
                ...
                children: [
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: _isAccepted && !_isConfirming
                          ? _confirmAppointment
                          : null,
  ...
  Widget _buildVaccineTypeSummary() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Container(
        ...
        Container(
          ...
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              // Ícono de vacuna (Mock)
              Container(
                width: 40,
                height: 40,
                decoration: BoxDecoration(
                  color: const Color(0xFFE8F5E9), // Verde claro para icon
                  borderRadius: BorderRadius.circular(8),
                ),
                child: const Icon(Icons.vaccines, color: Color(0xFF2E7D32), size: 24),
              ),
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Vacuna VPH', style: AppTheme.heading3().copyWith(fontSize: 15)),
                    const SizedBox(height: 4),
                    Text(
                      'Prevén el cáncer cervicouterino.\nDe 9 años en adelante.',
                    ...
                    RichText(
                      text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: 'MXN',
                            style: AppTheme.body().copyWith(fontSize: 10, color: AppTheme.textSecondary),
                          ),
                        ],
                      ),
                    ),
...
// Reutilizado de vaccine_patient_info_screen.dart
