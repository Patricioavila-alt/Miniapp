...
class DateOption {
  ...
  DateOption(this.dayNumber, this.dayName, {this.isAvailable = true});
}
...
class TimeOption {
  ...
  TimeOption(this.time, {this.isAvailable = true});
}

class VaccineDateTimeScreen extends StatefulWidget {
  const VaccineDateTimeScreen({super.key});

  @override
  State<VaccineDateTimeScreen> createState() => _VaccineDateTimeScreenState();
}

class _VaccineDateTimeScreenState extends State<VaccineDateTimeScreen> {
  ...
  final List<DateOption> _dates = [
    DateOption('17', 'Mar'),
    DateOption('18', 'Mié', isAvailable: false),
    DateOption('19', 'Jue'),
    DateOption('20', 'Vie'),
    DateOption('21', 'Sáb', isAvailable: false),
    DateOption('22', 'Dom'),
    DateOption('23', 'Lun'),
  ];
  DateOption? _selectedDate;

  final List<TimeOption> _times = [
    TimeOption('09:00'),
    TimeOption('09:15'),
    TimeOption('09:30'),
    TimeOption('09:45'),
    ...
    TimeOption('10:15'),
    TimeOption('10:30'),
    TimeOption('10:45', isAvailable: false),
    TimeOption('11:00', isAvailable: false),
    TimeOption('11:15'),
    TimeOption('11:30', isAvailable: false),
    TimeOption('11:45', isAvailable: false),
    TimeOption('12:00'),
    TimeOption('12:15'),
    TimeOption('12:30'),
    TimeOption('12:45'),
    ...
    TimeOption('13:45'),
    TimeOption('14:00'),
    TimeOption('14:15', isAvailable: false),
    TimeOption('14:30'),
    TimeOption('14:45', isAvailable: false),
  ];
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 24),
                            child: Text(
                              '¿Cuándo te gustaría aplicarte la vacuna?',
                              style: AppTheme.heading2().copyWith(fontSize: 18),
                            ),
                          ),
                          const SizedBox(height: 16),
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _isNextEnabled
                      ? () {
                          context.push(AppRoutes.vaccinePatientInfo);
                        }
                      : null,
  ...
  Widget _buildDateCard(DateOption date, bool isSelected) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isSelected
                ? const Color(0xFF3B82F6) // Azul claro de selección
                : (date.isAvailable ? AppTheme.border : const Color(0xFFEEEEEE)),
          ...
          children: [
            Text(
              ...
              style: AppTheme.heading2().copyWith(
                color: isSelected
                    ...
                    : (date.isAvailable ? AppTheme.textPrimary : const Color(0xFFCCCCCC)),
                fontSize: 18,
              ),
            ),
            ...
            Text(
              ...
              style: AppTheme.body().copyWith(
                color: isSelected
                    ? const Color(0xFF3B82F6)
                    : (date.isAvailable ? AppTheme.textSecondary : const Color(0xFFCCCCCC)),
                fontSize: 12,
              ),
            ),
          ],
  ...
  Widget _buildTimePill(TimeOption time, bool isSelected) {
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isSelected
                ? const Color(0xFF3B82F6)
                : (time.isAvailable ? AppTheme.border : const Color(0xFFEEEEEE)),
            width: isSelected ? 1.5 : 1,
          ),
        ),
        ...
        child: Text(
          ...
          style: AppTheme.bodyBold().copyWith(
            color: isSelected
                ? const Color(0xFF3B82F6)
                : (time.isAvailable ? AppTheme.textPrimary : const Color(0xFFCCCCCC)),
            fontSize: 13,
          ),
        ),
      ),
