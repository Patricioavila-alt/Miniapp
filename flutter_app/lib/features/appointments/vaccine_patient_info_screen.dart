...
class VaccinePatientInfoScreen extends StatefulWidget {
  const VaccinePatientInfoScreen({super.key});

  @override
  State<VaccinePatientInfoScreen> createState() =>
      _VaccinePatientInfoScreenState();
}

class _VaccinePatientInfoScreenState extends State<VaccinePatientInfoScreen> {
  bool _isForMe = true;
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    if (_isFormValid()) {
                      context.push(AppRoutes.vaccineConfirmation);
                    }
                  },
  ...
  Widget _buildAddressForm() {
    ...
    return Column(
      ...
      children: [
        ...
        _buildDropdown('Municipio *', _municipality, _municipalities, (val) {
...
// Widget personalizado para las secciones colapsables
