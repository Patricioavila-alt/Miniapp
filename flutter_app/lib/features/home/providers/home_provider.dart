...
final _mockHomeData = HomeData(
  ...
  quickActions: [
    {'id': 'vaccine',      'label': 'Vacuna',             'icon': 'CitaVacunasV2'},
    {'id': 'tests',        'label': 'Prueba',              'icon': 'CitaPruebasV2'},
    {'id': 'medicoGeneral','label': 'Médico\nGeneral',    'icon': 'Expediente'},
    {'id': 'pediatra',     'label': 'Pediatra',            'icon': 'DoctorGeneral'},
    {'id': 'dermatologia', 'label': 'Dermatología',        'icon': 'Derma'},
    {'id': 'diabetes',     'label': 'Nutriólogo',          'icon': 'DoctorGeneral'},
    {'id': 'saludMental',  'label': 'Salud\nMental',      'icon': 'DoctorGeneral'},
    {'id': 'redmedica',    'label': 'Red\nMédica',         'icon': 'RedMedicaV2'},
  ],
  promotions: [
    Promotion(
      id: 'promo_01',
    ...
    Promotion(
      ...
      imageUrl: 'https://images.unsplash.com/photo-1505751172876-fa1923c5c528?q=80&w=400&auto=format&fit=crop',
      ctaText: 'Agendar',
      ctaAction: 'schedule',
    ),
    Promotion(
